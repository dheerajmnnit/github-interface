...
class App extends Component {
    ...
    render() {
        return (
            <>
                <div id="App">
                    <Header onSubmitHandler={this.onSubmitHandler} onChangeHandler={this.onChangeHandler} name={this.state.name} />
                    ...
                    */}
                    ...
                    <Switch>
                        ...
                        <Route path={`/profile/${this.state.username}`} exact
                            render={() => (
                                <Profile userDoesntExist={this.state.userDoesntExist} onProfileMount={this.onProfileMount} />
                            )}
                        />
                    </Switch>
                </div>
